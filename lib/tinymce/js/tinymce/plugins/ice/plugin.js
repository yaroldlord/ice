			...
			ed.ui.registry.addToggleButton('ice_toggleoriginal', {
				...
				onSetup: (buttonApi) => {
					...
					const editorEventCallback = (eventApi) => {
						...
						ed.plugins.ice.showOriginalButton.disabled = self.disabled;
						ed.plugins.ice.showOriginalButton.active = self.active;
					};
					ed.on('init', editorEventCallback);
					return (buttonApi) => editor.off('init', editorEventCallback);
				}
            ...
            ed.ui.registry.addToggleButton('ice_toggleallmarkup', {
                ...
                onSetup: (buttonApi) => {
                    ...
                    const editorEventCallback = (eventApi) => {
		                    ...
		                    ed.plugins.ice.showAllMarkupButton.disabled = self.disabled;
		                    ed.plugins.ice.showAllMarkupButton.active = self.active;
                    };
                    ed.on('init', editorEventCallback);
					setTimeout(function () {
						ed.execCommand('ice_toggleallmarkup');
			...
			ed.ui.registry.addToggleButton('ice_togglenomarkup', {
				...
				onSetup: (buttonApi) => {
					...
					const editorEventCallback = (eventApi) => {
						...
						ed.plugins.ice.showNoMarkupButton.disabled = self.disabled;
						ed.plugins.ice.showNoMarkupButton.active = self.active;
					};
					ed.on('init', editorEventCallback);
					return (buttonApi) => editor.off('init', editorEventCallback);
				}
